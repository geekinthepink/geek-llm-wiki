...
I wanted Claude to create a UI that was timed with the words I was saying, but I wasn't sure if it would be able to so I asked Claude to create a prototype video using Remotion and a transcription to see if it would work.
